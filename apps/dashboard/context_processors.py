...
def merchant_permissions(request):
    ...
    return {
        ...
        "can_manage_storefront_layout": membership_has_permission(membership, STOREFRONT_LAYOUT_MANAGE),
        "can_manage_collections": membership_has_permission(membership, COLLECTION_MANAGE),
