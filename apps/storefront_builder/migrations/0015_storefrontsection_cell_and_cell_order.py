    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text=(
                    "Phase 2A (پایه‌یِ چندبلاکیِ Cell): ارجاعِ موازی و انتقالی به "
                    "Cellی که این section در آن قرار گرفته — مکملِ رابطه‌یِ قدیمیِ "
                    "StorefrontCell.section (OneToOne) که همچنان تنها منبعِ حقیقتِ "
                    "اجراییِ امروز است. هیچ سرویس/ویو/تمپلیتِ رندری در Phase 2A از "
                    "این فیلد نمی‌خوانَد."
                ),
            ),
        ),
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                ...
                help_text=(
                    ...
                    "در میانِ بلاک‌هایِ همان Cell (Phase 2B). عمداً جدا از order بالاست."
                ),
            ),
        ),
