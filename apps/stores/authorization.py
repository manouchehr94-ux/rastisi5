...
DISCOUNT_MANAGE = "discount.manage"  # reserved — no discount admin view yet
...
_ORDER_READ_WRITE = frozenset({ORDER_VIEW, ORDER_STATUS_CHANGE, CUSTOMER_VIEW, CUSTOMER_EDIT})
